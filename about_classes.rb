...
class AboutClasses < Neo::Koan
  ...
  def test_args_to_new_must_match_initialize
    ...
    # THINK ABOUT IT:
    # Why is this so?
    #Else, if you give 4 args out of five, how do you determine are they? (0..3 or 1..4)
    # ^ that's why named arguments exist, I assume? (also, passing them in any order)
  end
  ...
  def test_inside_a_method_self_refers_to_the_containing_object
    ...
    assert_equal fido.instance_eval("self"), fidos_self
  end
